...
grep_insert_table_values cfdi_40_estados "'M.*?','(MEX|USA|CAN)'"
grep_insert_table_values cfdi_40_exportaciones
...
grep_insert_table_values cfdi_40_municipios "'210'"
grep_insert_table_values cfdi_40_municipios "'.*?','BCN'"
